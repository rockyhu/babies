					...
					<div class="box box-primary">
						<div class="box-body">
							<ul class="nav nav-tabs">
								<li class="active"><a href='{:U("Document/index")}'><i class="ion-ios-paper"></i> 文档列表</a></li>
								{$btn_html}
							</ul>
							<div class="panel panel-default no-border no-panel">
								<div class="panel-body no-padding">
									<table id="table-document" class="table table-bordered table-hover" width="100%">
										<thead>
										<tr>
											<th width="10px"></th>
											<th>文档</th>
...
<script type="text/javascript">
	var ThinkPHP = {
		...
		'ajaxDocumentList' : '{:U("Document/ajaxDocumentList")}',
        'documentnavlist' : <empty name="documentnavlist">''<else />{$documentnavlist}</empty>
	};
</script>
