					...
					<div class="box box-primary">
						<div class="box-body">
							<ul class="nav nav-tabs">
								...
								{$btn_html}
								<li class="active"><a href='javascript:void(0);'><i class="ion-ios-compose"></i> 修改文档</a></li>
							</ul>
									...
									<form method="post" id="document-edit">
										...
										<div class="box-footer">
											<div class="pull-right">
												<button type="submit" class="btn btn-primary" id="document-edit-btn"><i class="fa fa-save"></i> 保存</button>
											</div>
										</div>
									</form>
								</div>
