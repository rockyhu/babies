                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href='{:U("Manage/index")}'><i class="ion-ios-paper"></i> 管理员列表</a></li>
                                {$btn_html}
                            </ul>
                            <div class="panel panel-default no-border no-panel">
                                <div class="panel-body no-padding">
                                    <table id="table-manage" class="table table-bordered table-hover" width="100%">
                                        <thead>
                                        <tr>
                                            <th></th>
                                            <th>管理员账号</th>
...
<script type="text/javascript">
    var ThinkPHP = {
        ...
        'Managelist':'{:U("Manage/ajaxlistmanage")}'
    };
</script>
