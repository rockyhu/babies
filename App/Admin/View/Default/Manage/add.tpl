                                ...
                                <div class="panel-body no-padding">
                                    <form method="post" id="manage-add">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" name="manager" placeholder="管理员账号，必须是电子邮箱" />
                                            <span class="errorLabel"></span>
                                        </div>
                                        <label>真实姓名</label>
                                        <div class="form-group">
                                            <input class="form-control" name="realname" placeholder="管理员真实姓名" />
                                            <span class="errorLabel"></span>
                                        </div>
                                        <label>登录密码</label>
                                        <div class="form-group">
                                        ...
                                        <label>角色分配</label>
                                        <div class="form-group">
                                            <select class="form-control select2" name="role" data-placeholder="请选择管理员角色" style="width:100%;"></select>
                                            <span class="errorLabel"></span>
                                        </div>
                                        <div class="box-footer">
                                            <div class="pull-right">
                                                <button type="submit" class="btn btn-primary" id="manage-add-btn"><i class="fa fa-save"></i> 保存</button>
                                            </div>
                                        </div><!-- /.box-footer -->
                                    </form>
                                </div>
