    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href='javasript:void(0);'> 文档管理</a></li>
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href='{:U("DocumentNav/index")}'><i class="ion-ios-paper"></i> 分类列表</a></li>
                                {$btn_html}
                            </ul>
                            <div class="panel panel-default no-border no-panel">
                                <div class="panel-body no-padding">
                                    <table id="table-documentnavs" class="table table-bordered table-hover" width="100%">
                                        <thead>
                                        <tr>
                                            <th></th>
                                            <th>ID</th>
...
<script type="text/javascript">
    var ThinkPHP = {
        ...
        'ajaxDocumentNavList' : '{:U("DocumentNav/ajaxDocumentNavList")}'
    };
</script>
