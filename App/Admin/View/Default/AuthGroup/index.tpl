  ...
  <body class="skin-blue fixed sidebar-mini">
              ...
              <div class="box box-primary">
                <div class="box-body">
                    <ul class="nav nav-tabs">
                      <li class="active"><a href='{:U("AuthGroup/index")}'><i class="ion-ios-paper"></i> 角色列表</a></li>
                        {$btn_html}
                    </ul>
                    <div class="panel panel-default no-border no-panel">
                      <div class="panel-body no-padding">
                        <table id="table-authgroup" class="table table-bordered table-hover" width="100%">
                          <thead>
                          <tr>
                            <th></th>
                            <th>角色名称</th>
    ...
    <script type="text/javascript">
        var ThinkPHP = {
            ...
            'AuthGrouplist':'{:U("AuthGroup/ajaxlistauthgroup")}'
        };
    </script>
