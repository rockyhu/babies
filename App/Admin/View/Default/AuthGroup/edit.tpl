                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <ul class="nav nav-tabs">
                                ...
                                {$btn_html}
                                <li class="active"><a href='javascript:void(0);'><i class="ion-ios-compose"></i> 修改角色</a></li>
                            </ul>
                            <div class="panel panel-default no-border no-panel">
                                <div class="panel-body no-padding">
                                    <form method="post" id="authgroup-edit">
                                        <input type="hidden" name="id" value="{$oneAuthGroup.id}">
                                        <label>角色名称</label>
                                        <div class="form-group">
                                            <input class="form-control" name="title" value="{$oneAuthGroup.title}" placeholder="角色名称" />
                                                ...
                                                <volist name="allNavlist" id="list">
                                                    ...
                                                    <volist name="list.subNavlist" id="subNavlist1">
                                                        <tr class="second{$subNavlist1.id}">
                                                            ...
                                                            <td></td>
                                                            <td align="center" class="checkboxtd"><input type="checkbox" name="rules[{$subNavlist1.id}][]" value="{$subNavlist1.text}||{$subNavlist1.url}" <in name="subNavlist1.text" value="$oneAuthGroup.rules">checked="checked"</in> /></td>
                                                        </tr>
                                                        <volist name="subNavlist1.twoSubNavlist" id="twosubNavlist">
                                                            <!-- 菜单栏目选中时，对菜单操作进行判断，否则，不进行处理 -->
                                                            <in name="subNavlist1.text" value="$oneAuthGroup.rules">
                                                                <tr class="second{$subNavlist1.id}-child">
                                                                    ...
                                                                    <td align="center" class="checkboxtd">
                                                                        <input type="checkbox" name="rules[{$subNavlist1.id}][]" value="{$twosubNavlist.text}||{$twosubNavlist.url}" <in name="twosubNavlist.url" value="$oneAuthGroup['dosurl'][$subNavlist1['id']]">checked="checked"</in> />
                                                                    </td>
                                                                </tr>
                                                                <else />
                                                                <tr class="second{$subNavlist1.id}-child">
                                        ...
                                        <div class="box-footer">
                                            <div class="pull-right">
                                                <button type="submit" class="btn btn-primary" id="authgroup-edit-btn"><i class="fa fa-save"></i> 保存</button>
                                            </div>
                                        </div><!-- /.box-footer -->
                                    </form>
                                </div>
