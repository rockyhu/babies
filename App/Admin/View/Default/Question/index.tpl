  ...
  <body class="skin-blue fixed sidebar-mini">
              ...
              <div class="box box-primary">
                <div class="box-body">
                	<ul class="nav nav-tabs">
                      <li class="active"><a href='{:U("Question/index")}'><i class="ion-ios-paper"></i> 常见问题列表</a></li>
                      {$btn_html}
                    </ul>
                    <div class="panel panel-default no-border no-panel">
                    	<div class="panel-body no-padding">
                    		<table id="table-question" class="table table-bordered table-hover" width="100%">
                                <thead>
                                <tr>
                                  <th>#</th>
                                  <th>标题</th>
    ...
    <script type="text/javascript">
        var ThinkPHP = {
        	...
        	'AjaxQuestion' : '{:U("Question/AjaxQuestionList")}'
        };
    </script>
