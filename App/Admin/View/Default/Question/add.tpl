                        ...
                        <div class="box-body">
                            ...
                            <div class="panel panel-default no-border no-panel">
                                <div class="panel-body no-padding">
                                    <form method="post" id="question-add">
                                        <label>常见问题标题 <small class="tips">（常见问题标题长度不大于50个字符）</small></label>
                                        <div class="form-group">
                                            <input class="form-control" name="title" placeholder="常见问题标题" />
                                        ...
                                        <div class="box-footer">
                                            <div class="pull-right">
                                                <button type="submit" class="btn btn-primary" id="question-add-btn"><i class="fa fa-save"></i> 保存</button>
                                            </div>
                                        </div><!-- /.box-footer -->
                                    </form>
                                </div>
